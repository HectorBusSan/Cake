...
const HomeScreen=({navigation,route})=>{
    ...
    const [fadeIn,setFadeIn]= useState(new Animated.Value(-370));
    const showProfile=()=>{
    ...
    const Profile=()=>{
        return(
            ...
            display:"flex", flexDirection:"column", alignItems:"center",zIndex:100,padding:20, top:fadeIn, height:"auto"}}>
                ...
                {Usuario.rol===1?<TouchableOpacity style={{...style.buttonP,marginBottom:5,backgroundColor:"#ffc107"}}><Text style={{fontSize:18}} onPress={()=>navigation.navigate("Pedidos",UserA)}>Pedidos</Text></TouchableOpacity>:null}
